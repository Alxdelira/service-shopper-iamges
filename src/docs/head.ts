...
const swaggerOptions = {
    swaggerDefinition: {
        ...
        info: {
            ...
            description:
                "Esta API foi projetada especificamente para fornecer uma solução robusta e integrada para a leitura automatizada de hidrômetros de água e gás.\n\n" + "Com uma gama abrangente de rotas e funcionalidades, esta API permite a captura, processamento e análise de imagens de medidores de consumo, utilizando a avançada tecnologia da GEMINI AI para garantir a precisão e eficiência dos dados coletados.\n\n" + 
